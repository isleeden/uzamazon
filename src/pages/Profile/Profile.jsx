...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        setValue('mobile', profile.username)
        setValue('dob', profile.profile && profile.profile.dob)
    }, [profile])
    return (
        <div>
            <Header />
            <div className="container">
                <div className='profilePage'>
                    ...
                    <div className='profile_data'>
                        <div className='photo'>
                            <Avatar
                                size={{ xs: 40, sm: 50, md: 60, lg: 85, xl: 100, xxl: 220 }}
                        ...
                        <div className='name'>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input disabled {...register("mobile")}/>
                                <h3>Дата рождения:</h3>
                                <input {...register("dob")} />
                        ...
                        <div className='password'>
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <h3>Старый пароль:</h3>
                                <input {...register("firstName")} type='password' />
                                <h3>Новый пароль:</h3>
                                <input {...register("firstName")} type='password' />
                    ...
                    <div className='deleteAcc'>
                        <h3 onClick={showModal}>Удалить профиль</h3>
                        <p>При удалении профиля вы потеряете всю информацию об аккаунте и покупках</p>
                    </div>
                    <Modal
                        ...
                        width={800}
                        footer={[
                            <Button key="delete" className='deleteButton' onClick={handleDeleteAcc}>
                                Да, удалить
                            </Button>,
